    ...
    return (
        <div>
            ...
            <div className="container-fluid adminBox">
                <div className="adminInnerBox col-12 d-flex justify-content-center align-items-center" style={{ height: '70vh' }}>
                    <div className='d-flex flex-column flex-md-row justify-content-center align-items-center' style={{ height: '100%' }}>
                        <button 
