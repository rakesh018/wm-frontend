          ...
          <div className="content-wrapper ">
            <div className="me-1 text-center">
              ...
              <div className="proBox mt-4 p-2">
                ...
                <div >
                  <button className='history-btn' onClick={() => navigate('/adminDeposit')}>DEPOSIT</button>
                </div>
                <hr className='line m-2' />
                <div >
                  <button className='history-btn' onClick={() => navigate('/adminWithdraw')}> WITHDRAW</button>
                </div>
                <hr className='line m-2' />
                <div >
                  <button className='leader-btn' onClick={() => navigate('/transactionalAnalysis')}>TRANSACTION ANALYTICS</button>
                </div>
                <hr className='line m-2' />
                <div >
              ...
              <div className="mt-4 ms-3">
                <button className='admin-logout' onClick={handleLogoutClick}>LOGOUT</button>
              </div>
            </div>
          </div>
        </div>
