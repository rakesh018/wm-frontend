...
export const AdminNavbar = () => {
    ...
    return (
        <div className='mainAdminHomeBox'>
            ...
            >
                <ul>
                    <li><Link to='/adminHome' onClick={() => setIsMenuOpen(false)}>VIEW ALL USERS</Link></li>
                    <li><Link to='/adminDeposit' onClick={() => setIsMenuOpen(false)}>DEPOSIT</Link></li>
                    <li><Link to='/adminWithdraw' onClick={() => setIsMenuOpen(false)}>WITHDRAW</Link></li>
                    <li><Link to='/transactionalAnalysis' onClick={() => setIsMenuOpen(false)}>TRANSACTION ANALYTICS</Link></li>
                    <li><Link to='/chooseWinningTeam' onClick={() => setIsMenuOpen(false)}>GAMES</Link></li>
                    <li><Link to='/demoAccount' onClick={() => setIsMenuOpen(false)}>DEMO ACCOUNT</Link></li>
                    <li><Link to='/adminUPI' onClick={() => setIsMenuOpen(false)}>UPI ID</Link></li>
                    <li><Link to='/queries' onClick={() => setIsMenuOpen(false)}>SUPPORT</Link></li>
                </ul>
            </div>
